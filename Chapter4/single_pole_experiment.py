####################################################################################
# This file provides the source code of the Single-Pole balancing experiment using #
# on NEAT-Python library                                                           #
####################################################################################
...
def run_experiment(config_file, n_generations=100):
    ...
    visualize.draw_net(
        config, best_genome, True, node_names=node_names, directory=out_dir, fmt='svg'
    )
